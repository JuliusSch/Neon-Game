...
public class SequencerNode extends BehaviourNode {
	...
	public SequencerNode(AIBlackboard bb, Mob mob) {
		super(bb, mob);
	}
	...
	public void update() {
		if (currentNode == null && childNodes.size() > 0 || currentState == NodeState.READY) {
			childNodeIter = 0;
		...
		if (currentNode.currentState == NodeState.SUCCESS) {
